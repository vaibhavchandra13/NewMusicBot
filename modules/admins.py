...
async def authenticate(client, message):
    ...
    if not message.reply_to_message:
        await message.reply("𝐑𝐞𝐩𝐥𝐲 𝐓𝐨 𝐚 𝐔𝐬𝐞𝐫!")
        return
    if message.reply_to_message.from_user.id not in admins[message.chat.id]:
        new_admins = admins[message.chat.id]
        new_admins.append(message.reply_to_message.from_user.id)
        admins[message.chat.id] = new_admins
        await message.reply("𝗦𝘂𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝗔𝘂𝘁𝗵𝗼𝗿𝗶𝘇𝗲𝗱 𝗨𝘀𝗲𝗿, 𝗡𝗼𝘄 𝗛𝗲/𝗦𝗵𝗲 𝗖𝗮𝗻 𝗔𝗱𝗺𝗶𝗻 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀")
    else:
        await message.reply("𝗦𝘂𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝗔𝘂𝘁𝗵𝗼𝗿𝗶𝘇𝗲𝗱 𝗨𝘀𝗲𝗿!")
...
async def deautenticate(client, message):
    ...
    if message.reply_to_message.from_user.id in admins[message.chat.id]:
        ...
        admins[message.chat.id] = new_admins
        await message.reply("𝐒𝐮𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐔𝐧𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝 𝐔𝐬𝐞𝐫, 𝐍𝐨𝐰 𝐇𝐞/𝐒𝐡𝐞 𝐂𝐚𝐧'𝐭 𝐀𝐝𝐦𝐢𝐧 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬")
    else:
        await message.reply("𝐒𝐮𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐔𝐧𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝 𝐔𝐬𝐞𝐫!")
